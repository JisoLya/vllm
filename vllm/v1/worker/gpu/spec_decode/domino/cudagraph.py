...
def _prepare_domino_inputs_to_capture(
    num_reqs: int,
    num_tokens: int,
...
class DominoCudaGraphManager(CudaGraphManager):
    """Domino CudaGraphManager for the parallel-drafting query forward,
    ...
    def capture(
        ...
        def create_forward_fn(
            ...
            attn_state = _prepare_domino_inputs_to_capture(
                num_reqs,
                num_tokens,
                input_buffers,
                block_tables,
